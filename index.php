...
<?php
    ...
    if(isset($_GET["update"])){ 
        ...
        $url = $result['signed_url'];
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_USERAGENT, 'discogs_api_example/1.1 +http://myweb.ttu.edu/mblair');
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    echo '<center><img src="collection_logo.png"></center><br><hr><br>';
    echo '<div class="container">';
    echo '<h1 style="float:left">Records</h1><h2 style="float:right"><a href="http://lollookup.com/index.php?update=true">Update Collection</a> | <a href="http://lollookup.com/about.html">About</a></h2><br><br><br>';
    echo '<table class="table">';
    echo '<thead>';
    echo '<tr>';
    echo '<th>Artist - Title ( Label(s) - Catalog#(s) )</th>';
    echo '<th>Format</th>';
    echo '<th>Year</th>';
    echo '<th>Rating</th>';
    
    echo '<th>Media Condition</th>';
    echo '<th>Sleeve Condition</th>';
    echo '<th>Notes (Total Value: $' . $total_collection_value . ')</th>';
